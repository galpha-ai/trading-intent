...
\textbf{White Paper for the public repository:} \href{https://github.com/galpha-ai/trading-intent}{github.com/galpha-ai/trading-intent}. This note is the architectural white paper for that repository and explains the semantic contract layer it implements today, together with the execution hierarchy it motivates as future work.
}}
\end{center}
